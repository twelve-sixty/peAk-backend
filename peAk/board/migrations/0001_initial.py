# Generated by Django 2.1.5 on 2019-02-05 23:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resort_location_longitude', models.DecimalField(decimal_places=15, max_digits=30)),
                ('resort_location_latitude', models.DecimalField(decimal_places=15, max_digits=30)),
                ('resort_address_line1', models.CharField(max_length=64)),
                ('resort_address_line2', models.CharField(blank=True, max_length=64)),
